...
\cventry{October 2011 -- Present}{PhD student}{Imperial College London}{PI: Dr Anil A. Bharath}{}{I am currently designing core algorithms for visual localisation based on crowdsourced paths. I have also built and benchmarked two novel datasets:
\begin{itemize}
...
\item A house-hold products dataset (the SHORT-30 dataset). SHORT-30 contains more than 150,000 images capturing usage particularities of blind and partially sighted people.
\end{itemize}
}
